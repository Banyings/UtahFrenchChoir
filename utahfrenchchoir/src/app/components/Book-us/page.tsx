          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <input
                ...
                className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 border-gray-500"
            ...
            <div className="flex justify-end">
              <button
                type="submit"
                className="bg-green-600 py-2 px-6 rounded-md hover:bg-green-700 transition-colors duration-200"
              >
                Send Message
              </button>
            </div>
